                    ...
                    <div class="col-md-6 col-sm-6 col-lg-4">
                        <div class="cont-info-box-wrap w-100">
                            <div class="cont-info-box text-center position-relative w-100 pat-bg white-layer opc8 back-blend-multiply bg-white"
                                ...
                                <p class="mb-0">+233 55 176 8231</p> 
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-6 col-lg-4">
                        <div class="cont-info-box-wrap w-100">
                            <div class="cont-info-box text-center position-relative w-100 pat-bg white-layer opc8 back-blend-multiply bg-white"
                                ...
                                <p class="mb-0"><a href="javascript:void(0);" title="">info@gmsa-ug.com</a></p> 
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-6 col-lg-4">
                        <div class="cont-info-box-wrap w-100">
                            <div class="cont-info-box text-center position-relative w-100 pat-bg white-layer opc8 back-blend-multiply bg-white"
                                ...
                                <p class="mb-0">Ug Central Mosque, University of Ghana</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-12 col-lg-6">
                        <div class="cont-info-desc w-100">
                            ...
                            <p class="mb-0">We do fast phone repair. In most to repair your device in just minutes, li
                                we’ll normally get con nection inutes, we’ll normally ge.</p>
                            <h6 class="mb-0">Follow us on social media</h6>
                            <div class="social-links2 v2 text-center d-inline-flex">
                                <a class="facebook" href="https://www.facebook.com/" title="Facebook" target="_blank"><i
                                        class="fab fa-facebook-f"></i></a>
                                <a class="twitter" href="https://twitter.com/" title="Twitter" target="_blank"><i
                                        class="fab fa-twitter"></i></a>
                                <a class="google" href="https://www.google.com/" title="Google Plus" target="_blank"><i
                                        class="fab fa-google-plus-g"></i></a>
                                <a class="linkedin" href="https://www.linkedin.com/" title="Linkedin" target="_blank"><i
                                        class="fab fa-linkedin-in"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-12 col-lg-6">
                        <form class="cont-form w-100">
